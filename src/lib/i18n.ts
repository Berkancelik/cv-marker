...
export const dict = {
  tr: {
    ...
    allTemplates: "Tüm şablonları gör",
    chooseTemplateTitle: "Şablonunu seç",
    chooseTemplateSubtitle: "Tüm şablonlar kategorilere göre. İstersen sadece fotoğraflı olanları göster.",
    photoOnly: "Fotoğraflı şablonlar",
    photoTemplateHint: "Bu şablonda fotoğraf alanı yok. Fotoğrafın görünmesi için fotoğraflı bir şablon seç.",
    preview: "Önizleme",
    ...
    clearConfirm: "Tüm alanlar boşaltılsın mı? Bu işlem geri alınamaz.",
  ...
  en: {
    ...
    allTemplates: "See all templates",
    chooseTemplateTitle: "Choose your template",
    chooseTemplateSubtitle: "Every template, grouped by category. Show only the ones with a photo if you like.",
    photoOnly: "With photo",
    photoTemplateHint: "This template has no photo area. Pick a template with a photo so your photo shows.",
    preview: "Preview",
    ...
    clearConfirm: "Clear all fields? This can't be undone.",
